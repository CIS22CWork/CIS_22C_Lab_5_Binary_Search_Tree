...
\item 
\hyperlink{class_node}{Node}$<$ T $>$ $\ast$ \hyperlink{class_list_a5def593117f99eb790be0997376d8208}{get\+Tail} ()
\item 
...
The front value 
\end{DoxyReturn}
\mbox{\Hypertarget{class_list_a5def593117f99eb790be0997376d8208}\label{class_list_a5def593117f99eb790be0997376d8208}} 
\index{List@{List}!get\+Tail@{get\+Tail}}
\index{get\+Tail@{get\+Tail}!List@{List}}
\subsubsection{\texorpdfstring{get\+Tail()}{getTail()}}
{\footnotesize\ttfamily template$<$class T $>$ \\
\hyperlink{class_node}{Node}$<$ T $>$ $\ast$ \hyperlink{class_list}{List}$<$ T $>$\+::get\+Tail (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily template$<$class T $>$ \\
bool \hyperlink{class_list}{List}$<$ T $>$\+::push\+\_\+front (\begin{DoxyParamCaption}\item[{T}]{val }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily template$<$class T $>$ \\
bool \hyperlink{class_list}{List}$<$ T $>$\+::remove (\begin{DoxyParamCaption}\item[{T}]{val }\end{DoxyParamCaption})}
